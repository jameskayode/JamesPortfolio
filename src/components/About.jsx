      ...
      <div className="flex flex-col justify-center items-center w-full h-full">
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          ...
          <div className="flex flex-col justify-center">
            ...
            Greetings! Client, it's a pleasure to meet you
            </p>
            {/* Description */}
            <p className="text-sm leading-7">
               I'm Joseph James Kayode, a dedicated Full Stack
              Developer with an extensive skill set encompassing React.js,
              Node.js, HTML, CSS, Tailwind CSS, DevOps, and Agile methodologies.
              I have a passion for creating intuitive and visually appealing
              user interfaces. Through my journey in web development, I've honed
              my abilities to create captivating user interfaces, develop robust
              server-side applications, and craft visually stunning designs with
              a keen eye for detail. In my portfolio, you'll discover a
              collection of projects that highlight not only my technical
              proficiency but also my commitment to delivering solutions that
              exceed expectations.
            </p>
